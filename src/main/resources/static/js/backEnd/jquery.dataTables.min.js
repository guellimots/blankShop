...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一頁",sPrevious:"前一頁"},sEmptyTable:"Table中無資料",sInfo:"顯示_TOTAL_筆中_START_到_END_筆",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(_MAX_筆項目中)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"顯示 _MENU_ 筆",sLoadingRecords:"查詢中...",sProcessing:"執行中...",sSearch:"查詢:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"查無資料"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
