                        ...
                        <div class="row">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo pt-40">
                                    <a href="/blankShop/frontEnd/indexPage"> <img src="/blankShop/assets/img/logo/logo.png" width="150px"
                                            alt="">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <div class="mobile-logo">
                                    <a href="/blankShop/frontEnd/indexPage"> <img alt="" src="/blankShop/assets/img/logo/logo.png"
                                            width="100px">
                                    </a>
                                </div>
                            </div>
