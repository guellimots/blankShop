...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- 訊息1 -->
            <div class="media">
              <img src="/blankShop/img/backEnd/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- 訊息2 -->
            <div class="media">
              <img src="/blankShop/img/backEnd/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- 訊息3 -->
            <div class="media">
              <img src="/blankShop/img/backEnd/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- 品牌logo -->
    <a class="brand-link">
      <img src="/blankShop/img/backEnd/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/blankShop/img/backEnd/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a class="d-block">${empname} ${empnid} </a> <!-- 員工登入顯示(照片、員編、姓名) -->
        </div>
      </div>
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
          <input class="form-control form-control-sidebar" type="search" placeholder="查詢" aria-label="Search">
  ...
  <div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
    ...
    <div class="tab-content">
      <div class="tab-empty">
        <h2 class="display-4">尚無資料</h2> <!-- 右側畫面 -->
      </div>
      <div class="tab-loading">
        <div>
          <h2 class="display-4">資料查詢中<i class="fa fa-sync fa-spin"></i></h2> <!-- 點擊功能時顯示 -->
        </div>
      </div>
    </div>
  </div>
